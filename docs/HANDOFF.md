...
11. **[FLUTTER_APP_RELEASE_AUDIT.md](FLUTTER_APP_RELEASE_AUDIT.md)** +
    ...
    **[MOBILE_DEVICE_QA_LOG.md](MOBILE_DEVICE_QA_LOG.md)** +
    **[MOBILE_RELEASE_CHECKLIST.md](MOBILE_RELEASE_CHECKLIST.md)** —
    ...
    flow; device QA log is the per-device evidence template the
    checklist signs off on; checklist is the go/no-go for first upload.
