...
- **[Android internal RC checklist](docs/ANDROID_INTERNAL_RC.md)** — single-page pre-upload checklist for cutting an Internal testing release candidate (commit baseline, versioning, tests, signing + asset gates, build commands, artifact verification, QA evidence, sign-off block)
